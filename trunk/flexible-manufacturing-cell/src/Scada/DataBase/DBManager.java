...
public class DBManager {
    ...
    public MasterConfigurationData readParameters() {
        ...
        try {
            ...
            s1 = new Slave1ConfigurationData(gearBelt, axisBelt, rs.getInt("time"));
            ...
            e.printStackTrace();
            s1 = new Slave1ConfigurationData(new BeltConfigurationData(10,20,50), new BeltConfigurationData(10,20,50), 3);
        ...
        try {
            ...
            s2 = new Slave2ConfigurationData(weldingBelt, rs.getInt("time"));
           ...
           /* md._slave2ConfigurationData._weldingBeltConfiguration.setLength(10);
            ...
            md._slave2ConfigurationData._activationTime = 30;*/
             s2 = new Slave2ConfigurationData(new BeltConfigurationData(10,20,-1), 30);
        ...
        try {
            ...
            s3 = new Slave3ConfigurationData(okBelt, notOkBelt, rs.getInt("time"));
           ...
           /* md._slave3ConfigurationData._qualityControlBelt.setLength(10);
            ...
            md._slave3ConfigurationData._activationTime = 5;*/
             s3 = new Slave3ConfigurationData(new BeltConfigurationData(10,10,-1), new BeltConfigurationData(10,-1,-1), 5);
